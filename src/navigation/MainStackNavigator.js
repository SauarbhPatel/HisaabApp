...
export default function MainStackNavigator() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="DevPaymentPage" component={DevPaymentPageScreen} options={{ presentation: 'card' }} />
      <Stack.Screen name="FriendDetail" component={FriendDetailScreen} options={{ presentation: 'card' }} />
      <Stack.Screen name="GroupDetail" component={GroupDetailScreen} options={{ presentation: 'card' }} />
      <Stack.Screen name="ExpenseDetail" component={ExpenseDetailScreen} options={{ presentation: 'card' }} />
      <Stack.Screen name="DevDetail" component={DevDetailScreen} options={{ presentation: 'card' }} />
      <Stack.Screen name="ClientDetail" component={ClientDetailScreen} options={{ presentation: 'card' }} />

      {/* Tier 2 — form screens */}
      <Stack.Screen name="AddProject" component={AddProjectScreen} options={{ presentation: 'card' }} />
      <Stack.Screen name="AddGroup" component={AddGroupScreen} options={{ presentation: 'card' }} />
      <Stack.Screen name="AddFriend" component={AddFriendScreen} options={{ presentation: 'card' }} />
      <Stack.Screen name="AddExpense" component={AddExpenseScreen} options={{ presentation: 'card' }} />
      <Stack.Screen name="AddClientPay" component={AddClientPayScreen} options={{ presentation: 'card' }} />
      <Stack.Screen name="AddDevForm" component={AddDevFormScreen} options={{ presentation: 'card' }} />
      <Stack.Screen name="AddClientForm" component={AddClientFormScreen} options={{ presentation: 'card' }} />
      <Stack.Screen name="GroupAddExpense" component={GroupAddExpenseScreen} options={{ presentation: 'card' }} />
      <Stack.Screen name="DevPay" component={DevPayScreen} options={{ presentation: 'card' }} />

      {/* Tier 2 — manage screens */}
      <Stack.Screen name="MyDevs" component={MyDevsScreen} options={{ presentation: 'card' }} />
      <Stack.Screen name="MyClients" component={MyClientsScreen} options={{ presentation: 'card' }} />

      {/* Tier 3A — slide-up modal screens */}
      <Stack.Screen name="Settle" component={SettleScreen} options={{ presentation: 'modal' }} />
      <Stack.Screen name="GiveMoney" component={GiveMoneyScreen} options={{ presentation: 'modal' }} />
      <Stack.Screen name="GetMoney" component={GetMoneyScreen} options={{ presentation: 'modal' }} />
      <Stack.Screen name="EditProject" component={EditProjectScreen} options={{ presentation: 'modal' }} />
      <Stack.Screen name="Status" component={StatusScreen} options={{ presentation: 'modal' }} />
      <Stack.Screen name="EditDev" component={EditDevScreen} options={{ presentation: 'modal' }} />
      <Stack.Screen name="DevStatus" component={DevStatusScreen} options={{ presentation: 'modal' }} />
      <Stack.Screen name="EditClient" component={EditClientScreen} options={{ presentation: 'modal' }} />
      <Stack.Screen name="ClientStatus" component={ClientStatusScreen} options={{ presentation: 'modal' }} />
      <Stack.Screen name="AddDevToProject" component={AddDevToProjectScreen} options={{ presentation: 'modal' }} />
    </Stack.Navigator>
  );
}
